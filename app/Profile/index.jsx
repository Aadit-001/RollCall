...
const ProfileScreen = () => {
  ...
  const fetchUserData = useCallback(async () => {
    ...
    try {
      ...
      const get_data = await AsyncStorage.multiGet([
        "userName", "userTimetable", "percentage", "timetable", "timetableData", "subjects", "appRating"
      ]);
      console.log("Stored Data:", get_data[5]);
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.profileInfoContainer}>
          ...
          <View style={styles.nameContainer}>
            ...
            <TouchableOpacity onPress={handleEditNameOpen} activeOpacity={0.7} style={styles.editIcon}>
              <Ionicons name="pencil-outline" size={20} color="#E0E0E0" style={styles.pencilIcon}/>
            </TouchableOpacity>
          </View>
      ...
      <Modal
        ...
        transparent={true}
        animationType="slide"
        onRequestClose={handleEditNameClose}
      >
        <KeyboardAvoidingView style={styles.modalContainer} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
          <View style={styles.rateModalContent}>
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity 
                style={styles.modalCloseButton}
                onPress={handleEditNameClose}
              >
                <Ionicons name="close-outline" size={24} color="#fff" />
              </TouchableOpacity>
            </View>
            
            <View style={styles.editNameModalBody}>
              <Text style={styles.editNameLabel}>Enter your name</Text>
              <TextInput
      ...
      <Modal
        visible={showNameUpdateSuccessModal}
        transparent={true}
        animationType="fade"
        onRequestClose={() => setShowNameUpdateSuccessModal(false)}
      >
        <View style={styles.modalContainer}>
          <View style={styles.rateModalContent}>
            <Ionicons name="checkmark-circle" size={60} color="#4CAF50" />
            <Text style={styles.thankYouText}>Name Updated</Text>
            <Text style={[styles.rateModalText, { marginBottom: 25 }]}>
              Your name has been updated successfully.
            </Text>
            <TouchableOpacity
              style={styles.doneButton}
              onPress={() => setShowNameUpdateSuccessModal(false)}
            >
              <Text style={styles.doneButtonText}>Done</Text>
            </TouchableOpacity>
          </View>
